...
const YoungonUserSchema = new Schema({
  ...
  post: {type: Number, index: true},                                      // 1代表站长 2副站, 3代表部长 4代表正式站员 5代表实习站员
  state: Number,                                                          // 1代表在站 代表不在站
  ...
  fistWorkTimeDate: Number,
  fistWorkTimeTime: Number,
  secondWorkTimeDate: Number,
  secondWorkTimeTime: Number,
